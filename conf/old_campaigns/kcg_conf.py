...
conf = {
    ...
    'instruments':{
        ...
        'asi': {'dsname': 'asiskycoverM1.b1', 'override_delta': 1440},
        'ceil': {'dsname': 'ceilM1.b1'},
        'csphot': {'dsname': 'csphotaodfiltv3M1.a1', 'override_delta': 30},
        ...
        'minimpl': {'dsname': 'minimplS1.b1'},
        'mpl': {'dsname': 'mplpolfsM1.b1'},
        'mwr': {'dsname': 'mwrlosM1.b1'},
        'mwr3c': {'dsname': 'mwr3cM1.b1'},
        'rwp': {'dsname': '1290rwpwindconM1.a1', 'dsname2': '1290rwpprecipcon', 't_delta': 60},
        ...
        'acsm': {'dsname': 'acsmtofspecX30.a1', 't_delta': 30},
